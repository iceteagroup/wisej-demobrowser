namespace Wisej.Web.Ext.Ignite.Demo.Component
{
	partial class igDoughnutChart
	{
		...
		private void InitializeComponent()
		{
			...
			this.igDoughnutChart1.WidgetFunctions = new Wisej.Web.Ext.Ignite.igBase.WidgetFunction[0];
			// 
			// textBox1
			// 
			...
			this.numericUpDown1.Size = new System.Drawing.Size(195, 50);
			...
			this.Load += new System.EventHandler(this.igDoughnutChart_Load);
