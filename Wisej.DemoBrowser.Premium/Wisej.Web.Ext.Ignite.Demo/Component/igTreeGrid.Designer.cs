namespace Wisej.Web.Ext.Ignite.Demo.Component
{
	partial class igTreeGrid
	{
		...
		{
			Wisej.Resources.ComponentResourceManager resources = new Wisej.Resources.ComponentResourceManager(typeof(igTreeGrid));
        ...
        widgetFunction2};
			...
			this.Load += new System.EventHandler(this.igTreeGrid_Load);
