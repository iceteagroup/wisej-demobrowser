...
{
	public partial class igDataChartIndicator : TestBase
	{
		...
		private void igDataChartIndicator_Load(object sender, EventArgs e)
		{
			...
			igDataChart1.Options.title = "Financial Chart";
			...
			igDataChart1.Options.series = new dynamic[]
			{
				new
				{
					type = "moneyFlowIndexIndicator", isTransitionInEnabled = true, closeMemberPath = "Close",
					highMemberPath = "High", lowMemberPath = "Low", openMemberPath = "Open",
					volumeMemberPath = "Volume", xAxis = "xAxis", yAxis = "yAxis", name = "indicatorSeries",
		...
		{
			igDataChart1.Instance.addItem(new
			{
				Index = 51,
				Date = "5/7/2013",
				Open = 25.72,
		...
		{
			igDataChart1.Options.isSquare = checkBox1.Checked;
			igDataChart1.Options.isHorizontalZoomEnabled = checkBox2.Checked;
			igDataChart1.Options.highlightingTransitionDuration = numericUpDown1.Value;
