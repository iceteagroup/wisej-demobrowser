...
{
	public partial class ejDiagram : TestBase
	{
		public ejDiagram()
		{
			InitializeComponent();
		...
		private void ejDiagram_Load(object sender, EventArgs e)
		{
			this.ejDiagram1.Options.pageSettings = new
			{
			...
			this.ejDiagram1.Options.enableContextMenu = true;
		}
		...
		private void LoadFlowchart()
		{
			var nodes = new object[]
			{
				new
				{
					name = "node1", offsetX = 400, offsetY = 30, fillColor = "#C44E5F",
					labels = new[] {new {text = "Start"}}, shape = "terminator"
				},
				new
				{
					name = "node2", offsetX = 400, offsetY = 100, fillColor = "#5e5f5f",
					labels = new[] {new {text = "Design"}}, shape = "process",
					ports = new[]
					{
				...
				new
				{
					name = "node3", offsetX = 400, offsetY = 180, fillColor = "#5e5f5f",
					labels = new[] {new {text = "Coding"}}, shape = "process",
					ports = new[]
					{
				...
				new
				{
					name = "node4", offsetX = 400, offsetY = 260, fillColor = "#5e5f5f",
					labels = new[] {new {text = "Testing"}}, shape = "process"
				},
				new
				{
					name = "node5", offsetX = 400, offsetY = 340, fillColor = "#4eab8b",
					labels = new[] {new {text = "Errors?"}}, shape = "decision"
				},
				new
				{
					name = "node6", offsetX = 400, offsetY = 450, fillColor = "#c44e5f",
					labels = new[] {new {text = "End"}}, shape = "terminator"
				},
				new
				{
					name = "node7", width = 120, offsetX = 220, offsetY = 180, fillColor = "#4eab8b",
					labels = new[] {new {text = "Design Error?"}}, type = "flow", shape = "decision",
					ports = new object[]
					{
			...
			var connectors = new object[]
			{
				...
				new
				{
					...
					labels = new object[] {new {text = "No", fillColor = "white"}}
				},
				new
				{
					name = "connector6", sourceNode = "node5", targetNode = "node7",
					segments = new object[] {new {type = "orthogonal", length = 150, direction = "left"}},
					labels = new object[] {new {text = "Yes", fillColor = "white"}}
				},
				new
				{
					name = "connector7", sourceNode = "node7", targetNode = "node3", sourcePort = "portcoding",
					targetPort = "codingPort",
					segments = new object[] {new {type = "orthogonal", length = 10, direction = "left"}},
					labels = new object[] {new {text = "No", fillColor = "white"}}
				},
				new
				{
					name = "connector8", sourceNode = "node7", targetNode = "node2", sourcePort = "porterror",
					targetPort = "designPort", labels = new object[] {new {text = "Yes", fillColor = "white"}}
				}
			};
			...
			this.ejDiagram1.Options.defaultSettings.node = new
			{
				...
				labels = new dynamic[]
				{
					new
					{
						fontColor = "white", fontSize = 12, bold = false, margin = new {left = 0, right = 0, top = 0},
						textAlign = "center", alignment = "center", horizontalAlignment = "center",
		...
		private void LoadHierarchicalTree()
		{
			...
			this.ejDiagram1.Options.layout = new
				{type = "hierarchicaltree", horizontalSpacing = 25, verticalSpacing = 35, marginX = 3, marginY = 3};
			...
			this.ejDiagram1.Options.defaultSettings.node = new
			{
				...
				labels = new object[]
				{
					new
					{
						fontColor = "white", fontSize = 12, bold = false, margin = new {left = 10, right = 10, top = 0},
						textAlign = "center", alignment = "center", horizontalAlignment = "center",
						verticalAlignment = "center"
					}
				}
		...
		private void LoadOrganizationalChart()
		{
			...
			this.ejDiagram1.Options.nodeTemplate = "nodeTemplate";
			this.ejDiagram1.Options.layout = new
				{type = "organizationalchart", horizontalSpacing = 25, verticalSpacing = 35, marginX = 3, marginY = 50};
			...
			this.ejDiagram1.Options.defaultSettings.node = new
			{
				...
				labels = new object[]
				{
					new
					{
						fontColor = "black", horizontalAlignment = "left", verticalAlignment = "top",
			...
			using (var stream = new StreamReader(Application.MapPath("Data\\OrganizationalChart.json")))
			{
				...
				this.ejDiagram1.Options.dataSourceSettings = new
					{id = "Id", parent = "ReportingPerson", dataSource = JSON.Parse(json)};
			}
		}
