namespace Wisej.Web.Ext.Syncfusion.Demo.Component
{
	partial class ejRotator
	{
		...
		{
			Wisej.Resources.ComponentResourceManager resources = new Wisej.Resources.ComponentResourceManager(typeof(ejRotator));
			...
			// 
			this.Name = "ejRotator";
			this.Load += new System.EventHandler(this.ejRotator_Load);
