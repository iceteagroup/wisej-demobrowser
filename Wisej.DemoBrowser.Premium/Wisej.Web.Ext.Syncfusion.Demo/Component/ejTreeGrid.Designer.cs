namespace Wisej.Web.Ext.Syncfusion.Demo
{
	partial class ejTreeGrid
	{
		...
		{
			Wisej.Resources.ComponentResourceManager resources = new Wisej.Resources.ComponentResourceManager(typeof(ejTreeGrid));
			...
			this.flowLayoutPanelProperties.Controls.Add(this.buttonGetSelectedCells);
			// 
			// ejTreeGrid1
			// 
			...
			this.checkBox3.Size = new System.Drawing.Size(212, 47);
			...
			this.Load += new System.EventHandler(this.ejTreeGrid_Load);
