ej.base.L10n.load({
  "pt": {
    ...
    "spreadsheet": {
      ...
      "UNIQUE": "Retorna valores únicos de um intervalo ou matriz",
      ...
      "EXACT": "Verifica se duas strings de texto são exatamente iguais e retorna VERDADEIRO ou FALSO.",
      "LEN": "Retorna vários caracteres em uma determinada string.",
      ...
      "EVEN": "Arredonda um número positivo para cima e um número negativo para baixo, para o número par mais próximo.",
      ...
      "DOLLAR": "Converte o número em texto formatado de moeda.",
      ...
      "TIME": "Converte horas, minutos e segundos em texto formatado com hora.",
      ...
      "UnProtectWorksheet": "Digite o título",
      "ReEnterPassword": "Folha de Desproteger",
      "SheetPassword": "Digite a senha novamente para continuar",
      ...
      "AutoFillMergeAlertMsg": "Formato de Documento Portátil",
    ...
    "documenteditor": {
      ...
      "Keep With Next": "Ignore uma vez",
      "Keep Lines Together": "Continue com o próximo",
      "WidowControl": "Mantenha as linhas juntas",
      "Indents and Spacing": "Controle de viúva / órfão",
      "Line and Page Breaks": "Recuos e espaçamento",
      "Pagination": "Quebras de linha e página",
      "Single": "Paginação",
      "DashSmallGap": "Solteiro",
      "DashDot": "DashSmallGap",
      "Double": "DashDot",
      "ThinThickSmallGap": "Dobro",
      ...
      "Inset": "DoubleWavy",
      "DashLargeGap": "Inserir",
      "Dot": "DashLargeGap",
      "DashDotDot": "Ponto",
      "Triple": "DashDotDot",
      "ThinThickThinSmallGap": "Triplo",
      ...
      "Number of columns must be between 1 and 63.": "O número de linhas deve estar entre 1 e 32767.",
      "Ignore all": "Ignore tudo"
    },
    "documenteditorcontainer": {
      ...
      "No color": "MAIÚSCULAS",
      "Top margin": "Sem cor",
      "Bottom margin": "Margem superior",
      "Left margin": "Margem inferior",
      "Right margin": "Margem esquerda",
      "Normal": "Margem direita",
      "Heading": "Normal",
      "Heading 1": "Cabeçalho",
      "Heading 2": "Cabeçallho 1",
      "Heading 3": "Título 2",
      "Heading 4": "Título 3",
      "Heading 5": "Título 4",
      "Heading 6": "Título 5"
