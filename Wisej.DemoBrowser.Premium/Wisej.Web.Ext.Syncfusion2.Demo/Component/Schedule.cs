...
{
	public partial class Schedule : TestBase
	{
		public Schedule()
		{
			InitializeComponent();
		...
		private void Schedule_Load(object sender, EventArgs e)
		{
			...
			this.schedule1.Options.selectedDate = "2021-01-15";
			this.schedule1.Options.eventSettings = new
			{
				dataSource = data.scheduleData
			};
		}
