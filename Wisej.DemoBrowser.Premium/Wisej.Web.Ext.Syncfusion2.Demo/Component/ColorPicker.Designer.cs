namespace Wisej.Web.Ext.Syncfusion2.Demo.Component
{
    ...
    "ted/";
			...
			this.checkBoxShowButton.Location = new System.Drawing.Point(3, 73);
			...
			this.checkBoxInline.Location = new System.Drawing.Point(3, 116);
			...
			// panelColorValue
			// 
			this.panelColorValue.BorderStyle = Wisej.Web.BorderStyle.Dashed;
			this.flowLayoutPanel1.SetFillWeight(this.panelColorValue, 1);
			this.flowLayoutPanel1.SetFlowBreak(this.panelColorValue, true);
			this.panelColorValue.Location = new System.Drawing.Point(3, 187);
