...
ej.base.L10n.load({
    "it-IT": {
        "grid": {
            ...
            "FilterbarTitle": "\"cella filtro bar",
            ...
            "UnGroupButton": "Clicca qui per separare",
            "AutoFitAll": "Adatta automaticamente tutte le colonne",
            "AutoFit": "Adatta automaticamente questa colonna",
            "Clear": "Chiara",
            ...
            "SortByOldest": "Ordina per più vecchio",
            "SortByNewest": "Ordina per più recente",
            "SortSmallestToLargest": "Ordina dal più piccolo al più grande",
            "SortLargestToSmallest": "Ordina dal più grande al più piccolo",
            "Sort": "Ordinare"
        },
        "pager": {
            "currentPageInfo": "{0} di {1} pagine",
            "totalItemsInfo": "({0} articoli)",
            ...
            "nextPagerTooltip": "Vai agli elementi del pager successivo",
            "previousPagerTooltip": "Vai agli elementi del pager precedenti",
            "pagerDropDown": "oggetti per pagina",
            "pagerAllDropDown": "Elementi",
            "All": "Tutti",
            "totalItemInfo": "({0} articolo)"
        },
        "kanban": {
            "items": "elementi",
            "min": "min",
            ...
            "addTitle": "Aggiungi nuova carta",
            "editTitle": "Modifica i dettagli della carta",
            "deleteTitle": "Elimina carta",
            "deleteContent": "Sei sicuro di voler eliminare questa carta?",
            "save": "Salva",
            "delete": "Elimina",
            "cancel": "Annulla",
            "yes": "sì",
            "no": "No",
            "close": "Vicino",
            "noCard": "Nessuna scheda da visualizzare",
        ...
        "spreadsheet": {
            ...
            "FindWhat": "Trovare cosa",
            "ReplaceWith": "Sostituirlo con",
            "EnterValue": "Inserisci il valore",
            "FileName": "Nome del file",
            "EnterName": "Inserisci il nome",
            "ExtendValidation": "La selezione contiene alcune celle senza convalida dei dati. Vuoi estendere la convalida a queste celle?",
            "Yes": "sì",
            "No": "No",
            "InvalidFileName": "Il nome del file contiene caratteri non validi.",
            "PROPER": "Converte un testo in maiuscolo corretto; la prima lettera in maiuscolo e le altre lettere in minuscolo.",
            "Cut": "Tagliare",
            "Copy": "copia",
            "Paste": "Incolla",
            ...
            "OutsideBorders": "Confini esterni",
            "InsideBorders": "Confini interni",
            "NoBorders": "Senza frontiere",
            ...
            "UnfreezePanes": "Sblocca i riquadri",
            ...
            "MultiRangeSortError": "Questo non può essere fatto su una selezione a più intervalli. Seleziona un singolo intervallo e riprova.",
            ...
            "UNIQUE": "Restituisce un valore univoco da un intervallo o un array",
            "TEXT": "Converte un valore in testo nel formato numerico specificato.",
            ...
            "SORT": "Ordina un intervallo di un array",
            "T": "Controlla se un valore è testo o meno e restituisce il testo.",
            "EXACT": "Controlla se due stringhe di testo sono esattamente uguali e restituisce VERO o FALSO.",
            "LEN": "Restituisce un numero di caratteri in una determinata stringa.",
            "MOD": "Restituisce un resto dopo che un numero è stato diviso per il divisore.",
            "ODD": "Arrotonda un numero positivo per eccesso e un numero negativo per difetto all'intero dispari più vicino.",
            "PI": "Restituisce il valore di pi greco.",
            "COUNTBLANK": "Restituisce il numero di celle vuote in un intervallo di celle specificato.",
            "EVEN": "Arrotonda un numero positivo per eccesso e un numero negativo per difetto all'intero pari più vicino.",
            "DECIMAL": "Converte una rappresentazione testuale di un numero in una data base in un numero decimale.",
            "ADDRESS": "Restituisce un riferimento di cella come testo, dati i numeri di riga e colonna specificati.",
            "CHAR": "Restituisce il carattere dal numero specificato.",
            "CODE": "Restituisce il codice numerico per il primo carattere in una data stringa.",
            "DOLLAR": "Converte il numero in testo formattato in valuta.",
            "SMALL": "Restituisce il k-esimo valore più piccolo in un dato array.",
            "LARGE": "Restituisce il k-esimo valore più grande in un dato array.",
            "TIME": "Converte ore, minuti, secondi nel testo formattato con l'ora.",
            "DEGREES": "Converte i radianti in gradi.",
            "FACT": "Restituisce il fattoriale di un numero.",
            "MEDIAN": "Restituisce la mediana del dato insieme di numeri.",
            "EDATE": "Restituisce una data con un determinato numero di mesi prima o dopo la data specificata.",
            "DATEVALUE": "Converte una stringa di data in un valore di data.",
            "NOW": "Restituisce la data e l'ora correnti.",
            "HOUR": "Restituisce il numero di ore in una stringa di tempo specificata.",
            "MINUTE": "Restituisce il numero di minuti in una stringa di tempo specificata.",
            "SECOND": "Restituisce il numero di secondi in una stringa di tempo specificata.",
            "MONTH": "Restituisce il numero di mesi in una stringa di data specificata.",
            "ShowRowsWhere": "Mostra righe in cui:",
            "OR": "O",
            "AND": "E",
            "CustomFilterDatePlaceHolder": "Scegli una data",
            ...
            "Undo": "Disfare",
            "Redo": "Rifare",
            "ClearAllFilter": "Chiaro",
            "ReapplyFilter": "Riapplica",
            "DateFilter": "Filtri data",
            "TextFilter": "Filtri di testo",
            "NumberFilter": "Filtri numerici",
            "ClearFilter": "Filtro pulito",
            ...
            "InCellDropDown": "In-cell-discesa",
            "Sources": "fonti",
            "Value": "Valore",
            "Retry": "Riprova",
            "DialogError": "La sorgente dell'elenco deve essere un riferimento a singola riga o colonna.",
            "MinMaxError": "Il Massimo deve essere maggiore o uguale al Minimo.",
            "Spreadsheet": "Foglio di calcolo",
            "MoreValidation": "Questa selezione contiene più di una convalida.",
            "FileNameError": " Cancellare le impostazioni correnti e continuare?",
            ...
            "SelectUnLockedCells": "Seleziona le celle",
            "Save": "Seleziona celle",
            "EmptyFileName": "Salva",
            "LargeName": "Il nome del file non può essere vuoto.",
            "FormatCells": "Formatta le celle",
            "FormatRows": "Formattare le righe",
            "Format Columns": "Formattare le colonne",
            ...
            "HighlightCellsRules": "Evidenzia le regole delle celle",
            "CFEqualTo": "Uguale a",
            "TextThatContains": "Testo che contiene",
            "ADateOccuring": "Una data che si verifica",
            "DuplicateValues": "Valori duplicati",
            "TopBottomRules": "Regole in alto / in basso",
            "Top10Items": "I 10 articoli migliori",
            "Top10": "Top 10",
            "Bottom10Items": "Ultimi 10 articoli",
            "Bottom10": "Inferiore 10",
            "AboveAverage": "Sopra la media",
            "BelowAverage": "Sotto la media",
            "FormatCellsGreaterThan": "Formatta le celle MAGGIORI DI:",
            "FormatCellsLessThan": "Formatta le celle MENO DI:",
            "FormatCellsBetween": "Formatta le celle che sono TRA:",
            "FormatCellsEqualTo": "Formatta le celle UGUALI A:",
            "FormatCellsThatContainTheText": "Formatta le celle che contengono il testo:",
            "FormatCellsThatContainADateOccurring": "Formatta le celle che contengono una data che si verifica:",
            "FormatCellsDuplicate": "Formatta le celle che contengono:",
            "FormatCellsTop": "Formatta le celle che si classificano nella TOP:",
            "FormatCellsBottom": "Formatta le celle che si trovano in BASSO:",
            "FormatCellsAbove": "Formatta le celle che sono SOPRA LA MEDIA:",
            "FormatCellsBelow": "Formatta le celle al di sotto della media:",
            "With": "con",
            "DataBars": "Barre dei dati",
            "ColorScales": "Scale di colori",
            "IconSets": "Set di icone",
            "ClearRules": "ClearRules",
            "SelectedCells": "Cancella regole dalle celle selezionate",
            "EntireSheet": "Cancella regole dall'intero foglio",
            "LightRedFillWithDarkRedText": "Riempimento rosso chiaro con testo rosso scuro",
            "YellowFillWithDarkYellowText": "Riempimento giallo con testo giallo scuro",
            "GreenFillWithDarkGreenText": "Riempimento verde con testo verde scuro",
            ...
            "DefinedNames": "Nomi definiti",
            "EnterTheTextToDisplay": "Immettere il testo da visualizzare",
            "EnterTheUrl": "Immettere l'URL",
            "INT": "Restituisce un numero all'intero più vicino.",
            "SUMPRODUCT": "Restituisce la somma del prodotto di determinati intervalli di array.",
            "TODAY": "Restituisce la data corrente come valore della data.",
            "ROUNDUP": "Arrotonda un numero lontano da zero.",
            "Replace": "Sostituire...",
            "Find": "Trova e sostituisci...",
            "Goto": "Vai a...",
            "GotoSpecial": "GotoSpecial ...",
            "Link": "Link",
            "SpreadsheetHyperlink": "Foglio di calcoloHyperlink",
            ...
            "RemoveHyperlink": "Rimuovi collegamento ipertestuale",
            "InvalidHyperlinkAlert": "L'indirizzo di questo sito non è valido. Controlla l'indirizzo e riprova.",
            "InsertLink": "Inserisci collegamento",
            "EditLink": "Modifica collegamento",
            "WrapText": "Avvolgere il testo",
            "Update": "Aggiornare",
            "SortAndFilter": "Ordina e filtra",
            "Filter": "Filtro",
            "FilterCellValue": "Filtra per valore della cella selezionata",
            "FilterOutOfRangeError": "Seleziona una cella o un intervallo all'interno dell'intervallo utilizzato e riprova.",
            "ClearFilterFrom": "Cancella filtro da",
            "LN": "Restituisce il logaritmo naturale di un numero.",
            "DefineNameInValid": "Il nome che hai inserito non è valido.",
            "LockCells": "Blocca celle",
            "EmptyError": "Devi inserire un valore",
            "ClearHighlight": "Evidenzia chiaro",
            "HighlightInvalidData": "Evidenzia dati non validi",
            "Clear": "Chiaro",
            ...
            "BlueDataBar": "Barra dati blu",
            "GreenDataBar": "Barra dati verde",
            "RedDataBar": "Barra dati rossa",
            "OrangeDataBar": "Barra dati arancione",
            "LightblueDataBar": "Barra dati azzurra",
            "PurpleDataBar": "Barra dei dati viola",
            "GYRColorScale": "Scala di colori verde - giallo - rosso",
            "RYGColorScale": "Scala dei colori rosso - giallo - verde",
            "GWRColorScale": "Scala di colori verde - bianco - rosso",
            "RWGColorScale": "Scala dei colori rosso - bianco - verde",
            "BWRColorScale": "Scala di colori blu - bianco - rosso",
            "RWBColorScale": "Scala dei colori rosso - bianco - blu",
            "WRColorScale": "Scala di colori bianco - rosso",
            "RWColorScale": "Scala di colori rosso - bianco",
            "GWColorScale": "Scala di colori verde - bianco",
            "WGColorScale": "Scala di colori bianco - verde",
            "GYColorScale": "Scala di colori verde - giallo",
            "YGColorScale": "Scala di colori giallo - verde",
            "ThreeArrowsColor": "3 frecce (colorate)",
            "ThreeArrowsGray": "3 frecce (grigio)",
            "ThreeTriangles": "3 triangoli",
            "FourArrowsColor": "4 frecce (grigio)",
            "FourArrowsGray": "4 frecce (colorate)",
            "FiveArrowsColor": "5 frecce (grigio)",
            "FiveArrowsGray": "5 frecce (colorate)",
            "ThreeTrafficLights1": "3 semafori (non bordati)",
            "ThreeTrafficLights2": "3 semafori (bordati)",
            "ThreeSigns": "3 segni",
            "FourTrafficLights": "4 semafori",
            "RedToBlack": "Dal rosso al nero",
            "ThreeSymbols1": "3 simboli (cerchiato)",
            "ThreeSymbols2": "3 simboli (non cerchiati)",
            "ThreeFlags": "3 bandiere",
            "ThreeStars": "3 stelle",
            "FourRatings": "4 Valutazioni",
            "FiveQuarters": "5 quarti",
            "FiveRatings": "5 valutazioni",
            "FiveBoxes": "5 scatole",
            "Chart": "Grafico",
            "Column": "Colonna",
            "Bar": "Bar",
            ...
            "Pie": "Torta",
            "Doughnut": "Ciambella",
            "PieAndDoughnut": "Torta / Ciambella",
            "Line": "Linea",
            "Radar": "Radar",
            "Scatter": "Scatter",
            "ChartDesign": "Disegno grafico",
            "ClusteredColumn": "Colonna raggruppata",
            "StackedColumn": "Colonna impilata",
            "StackedColumn100": "Colonna impilata al 100%",
            "ClusteredBar": "Bar raggruppato",
            "StackedBar": "Barra in pila",
            "StackedBar100": "Barra in pila 100%",
            "StackedArea": "Area in pila",
            "StackedArea100": "Area impilata al 100%",
            "StackedLine": "Linea in pila",
            "StackedLine100": "Linea impilata al 100%",
            "AddChartElement": "Aggiungi elemento grafico",
            "Axes": "Assi",
            ...
            "Legends": "Leggende",
            "PrimaryHorizontal": "Orizzontale primario",
            "PrimaryVertical": "Verticale principale",
            "None": "Nessuna",
            "AboveChart": "Sopra il grafico",
            "Center": "Centro",
            "InsideEnd": "Inside End",
            "InsideBase": "Base interna",
            "OutsideEnd": "OutSide End",
            "PrimaryMajorHorizontal": "Primaria maggiore orizzontale",
            "PrimaryMajorVertical": "Verticale principale principale",
            "PrimaryMinorHorizontal": "Primaria minore orizzontale",
            "PrimaryMinorVertical": "Verticale minore primaria",
            "Right": "Giusto",
            "Left": "Sinistra",
            ...
            "MaterialDark": "Materiale Scuro",
            "FabricDark": "FabricDark",
            "HighContrast": "Alto contrasto",
            "BootstrapDark": "BootstrapDark",
            "Bootstrap4": "Bootstrap4",
            "Bootstrap5Dark": "Bootstrap4",
            "Bootstrap5": "Bootstrap5 Scuro",
            "Tailwind": "Bootstrap5",
            "TailwindDark": "vento in poppa",
            "VerticalAxisTitle": "Titolo asse verticale",
            "HorizontalAxisTitle": "Titolo asse orizzontale",
            "EnterTitle": "Immettere il titolo",
            "UnProtectWorksheet": "Inserisci il titolo",
            "ReEnterPassword": "Foglio di rimozione della protezione",
            "SheetPassword": "Reinserire la password per procedere",
            "ProtectWorkbook": "Proteggi cartella di lavoro",
            "Password": "Password (opzionale):",
            "unProtectPassword": "Parola d'ordine",
            "EnterThePassword": "Immettere la password",
            "ConfirmPassword": "conferma password",
            "EnterTheConfirmPassword": "Reinserisci la tua password",
            "PasswordAlert": "La password di conferma non è identica",
            "UnProtectWorkbook": "Rimuovi protezione cartella di lavoro",
            "UnProtectPasswordAlert": "La password che hai fornito non è corretta.",
            "InCorrectPassword": "Impossibile aprire il file o il foglio di lavoro con la password fornita",
            "PasswordAlertMsg": "Si prega di inserire la password",
            "ConfirmPasswordAlertMsg": "Si prega di inserire la password di conferma",
            "IsProtected": "è protetto",
            "PDF": "Formato documento portatile",
            "AutoFillMergeAlertMsg": "Formato documento portatile",
        ...
        "filemanager": {
            ...
            "Tooltip-Cut": "Tagliare",
            "Tooltip-Copy": "copia",
            "Tooltip-Paste": "Incolla",
            "Tooltip-SortBy": "Ordina per",
            "Tooltip-Refresh": "ricaricare",
            ...
            "Header-Folder-Delete": "Elimina cartella",
            "Content-Folder-Delete": "Sei sicuro di voler eliminare questa cartella?",
            ...
            "Same-Folder-Error": "La cartella di destinazione è la stessa della cartella di origine.",
        ...
        "schedule": {
            ...
            "occurenceAlert": "Impossibile ripianificare un'occorrenza dell'appuntamento ricorrente se salta un'occorrenza successiva dello stesso appuntamento.",
        ...
        "gantt": {
            ...
            "outdent": "outdent",
            "segments": "Segmenti",
            "splitTask": "Attività divisa",
            "mergeTask": "Unisci attività",
            "left": "Sinistra",
            "right": "Destra"
        },
        "richtexteditor": {
        ...
        "numerictextbox": {
            ...
            "decrementTitle": "Valore di decremento"
        },
        "slider": {
            "incrementTitle": "Aumentare",
            "decrementTitle": "Diminuire"
        },
        "formValidator": {
        ...
        "pivotview": {
            ...
            "Equals": "È uguale a",
            "DoesNotEquals": "Non è uguale",
            "BeginWith": "Inizia con",
            "DoesNotBeginWith": "Non Cominciamo",
            "EndsWith": "Finisce con",
            ...
            "Max": "Max",
            "Index": "Indice",
            "SampleStDev": "StDev di esempio",
            "PopulationStDev": "Popolazione StDev",
            ...
            "details": "Dettagli",
            "manageRecords": "Gestire i record",
            "Years": "Anni",
            "Quarters": "alloggio",
            "Months": "mesi",
            "Days": "giorni",
            ...
            "Minutes": "Minuti",
            "Seconds": "secondi",
            "save": "Salva un rapporto",
            "new": "Crea un nuovo rapporto",
            "load": "Caricare",
            "saveAs": "Salva come rapporto corrente",
            "rename": "Rinomina un rapporto corrente",
            "deleteReport": "Elimina un rapporto corrente",
            "export": "Esportare",
            ...
            "groupName": "Immettere la didascalia da visualizzare nell'intestazione",
            "captionName": "Immettere la didascalia per il campo del gruppo",
            ...
            "exit": "Uscita",
            "invalidJSON": "Dati JSON non validi",
            "invalidCSV": "Dati CSV non validi",
            "stacked": "Impilati",
            "single": "Single",
            "multipleAxisMode": "Modalità multiasse",
            "grandTotalPosition": "Modalità a più assi",
            "top": "Posizione dei totali generali",
            "bottom": "Superiore",
            "None": "Metter il fondo a"
        },
        "pivotfieldlist": {
            ...
            "of": "di",
            "removeCalculatedField": "Sei sicuro di voler eliminare questo campo calcolato?",
            "yes": "Sei sicuro di voler eliminare questo campo calcolato?",
            "no": "sì",
            "None": "No"
        },
        "pdfviewer": {
            ...
            "highlight": "Cambia opacità",
            "underline": "Evidenziare",
            "strikethrough": "Sottolineare",
        ...
        "DocumentEditor": {
            ...
            "Cell margins": "Margini cellulari",
            "Same as the whole table": "Come tutto il tavolo",
            "Borders": "frontiere",
            "None": "Nessuna",
            "Dot": "Punto",
            "DashSmallGap": "Dash SmallGap",
            ...
            "SingleWavy": "Singolo Ondulato",
            "DoubleWavy": "Doppio Ondulato",
            ...
            "Multiple": "multiplo",
            "Spacing": "Spaziatura",
            "Define new Multilevel list": "Definire un nuovo elenco multilivello",
            ...
            "Underline style": "Sottolineare lo stile",
            ...
            "instances": "casi",
            "with": "con",
            "Click to follow link": "Clicca per seguire il link",
        ...
        "rich-text-editor": {
            ...
            "tableRows": "Righe della tabella",
            "tableColumns": "Colonne della tabella",
            "tableCellHorizontalAlign": "Allineamento orizzontale della cella della tabella",
            "tableCellVerticalAlign": "Allineamento verticale della cella della tabella",
            "createTable": "Crea tabella",
            "removeTable": "Rimuovi tabella",
            "tableHeader": "Intestazione tabella",
            "tableRemove": "Rimuovi tabella",
            "tableCellBackground": "Sfondo della cella della tabella",
            "tableEditProperties": "Proprietà Modifica tabella",
            "styles": "Stili",
            "insertColumnLeft": "Inserisci colonna a sinistra",
            "insertColumnRight": "Inserisci colonna a destra",
            "deleteColumn": "Elimina colonna",
            ...
            "insertRowAfter": "Inserisci riga dopo",
            "deleteRow": "Elimina riga",
            "tablerows": "tableRighe",
            "tablecolumns": "colonne da tavola",
            "tablecellhorizontalalign": "tableCellHorizontalAlign",
            "tablecellverticalalign": "tableCellVerticalAlign",
            "createtable": "crea tabella",
            "removetable": "rimuoviTabella",
            "tableheader": "tableHeader",
            "tableremove": "tabellaRimuovi",
            "tablecellbackground": "tableCellBackground",
            "tableeditproperties": "tableEditProperties",
            "insertcolumnleft": "inserisciColonnaSinistra",
            "insertcolumnright": "inserisciColumnRight",
            "deletecolumn": "cancella Colonna",
            "aligntop": "Allinea in alto",
            "alignmiddle": "Allinea al centro",
            "alignbottom": "Allinea in basso",
            "insertrowbefore": "inserisciRigaPrima",
            "insertrowafter": "inserisciRigaDopo",
        ...
        "PdfViewer": {
            ...
            "Underline context": "Sottolineare",
            "Strikethrough context": "Colpisci",
            "Server error": "Il servizio Web non è in ascolto. Visualizzatore PDF dipende dal servizio web per tutte le sue funzionalità. Si prega di avviare il servizio Web per continuare.",
            "Open text": "Aperto",
            "First text": "Prima pagina",
            "Previous text": "Pagina precedente",
            "Next text": "Pagina successiva",
            ...
            "Import Annotations": "Importa annotazioni dal file JSON",
            "Export Annotations": "Esporta l'annotazione in un file JSON",
            "Export XFDF": "Esporta annotazioni in file XFDF",
            "Import XFDF": "Importa annotazioni dal file XFDF",
            "Add": "Inserisci",
            "Clear": "Chiaro",
            "Bold": "Grassetto",
            "Italic": "Corsivo",
            "Strikethroughs": "Barrato",
            "Underlines": "Sottolineare",
            "Superscript": "Apice",
            "Subscript": "Pedice",
            "Align left": "Allineare a sinistra",
            "Align right": "Allinea a destra",
            "Center": "Centro",
            "Justify": "Giustificare",
            "Font color": "Colore del carattere",
            "Text Align": "Allineamento del testo",
            "Text Properties": "Stile carattere",
            "SignatureFieldDialogHeaderText": "Aggiungi firma",
            "HandwrittenSignatureDialogHeaderText": "Aggiungi firma",
            "InitialFieldDialogHeaderText": "Aggiungi iniziale",
            "HandwrittenInitialDialogHeaderText": "Aggiungi iniziale",
            "Draw Ink": "Disegna inchiostro",
            "Create": "Creare",
            "Font family": "Famiglia di font",
            "Font size": "Dimensione del font",
            "Free Text": "Testo libero",
            "Import Failed": "Tipo di file JSON o nome file non valido; seleziona un file JSON valido",
            "File not found": "Il file JSON importato non è stato trovato nella posizione desiderata",
            "Export Failed": "L'azione di esportazione delle annotazioni non è riuscita; assicurati che le annotazioni siano aggiunte correttamente",
            "of": "di",
            "Dynamic": "Dinamico",
            "Standard Business": "affari standard",
            "Sign Here": "Firmare qui",
            "Custom Stamp": "Timbro personalizzato",
            "Enter Signature as Name": "Inserisci il tuo nome",
            "Draw-hand Signature": "DISEGNARE",
            "Type Signature": "GENERE",
            "Upload Signature": "CARICARE",
            "Browse Signature Image": "NAVIGARE",
        ...
        "documenteditor": {
            ...
            "Header": "Intestazione",
            "Footer": "footer",
            "First Page Header": "Intestazione della prima pagina",
            "First Page Footer": "Primo piè di pagina",
            "Even Page Header": "Intestazione pagina pari",
            "Even Page Footer": "Anche il piè di pagina",
            "Odd Page Header": "Intestazione pagina dispari",
            "Odd Page Footer": "Piè di pagina dispari",
            "Margin": "margini",
            "Paper": "Carta",
            "Layout": "disposizione",
            "Orientation": "Orientamento",
            ...
            "Enforcing Protection": "Sì, inizia a applicare la protezione",
            "Start Enforcing Protection": "Inizia l'applicazione della protezione",
            "Enter User": "Inserisci utente",
            "Users": "utenti",
            "Enter new password": "Inserire una nuova password",
            "Reenter new password to confirm": "Immettere nuovamente la nuova password per confermare",
            ...
            "FormFieldsOnly": "Puoi compilare i moduli solo in questa regione.",
            "CommentsOnly": "Puoi inserire commenti solo in questa regione.",
            "ReadOnlyProtection": "Puoi modificare in questa regione.",
            ...
            "Drop Down Form Field": "Campo modulo a discesa",
            "Drop-down items": "Elementi a discesa",
            "Items in drop-down list": "Elementi nell'elenco a discesa",
            "ADD": "INSERISCI",
            "REMOVE": "RIMUOVERE",
            ...
            "All caps": "Tutto maiuscolo",
            "This region is locked by": "Questa regione è bloccata da",
            "Lock": "Serratura",
            "Unlock": "Sbloccare",
            "Already locked": "Selezionato o parte della regione è già bloccata da un altro utente",
            "1, 2, 3, ...": "1, 2, 3, ...",
            "a, b, c, ...": "a, b, c, ...",
            "A, B, C, ...": "A, B, C, ...",
            "I, II, III, ...": "I, II, III, ...",
            ...
            "Fillin enabled": "Fill-in abilitato",
            "Multiple Comment": "Inserisci il tuo commento",
            "InsertFootnote": "InsertFootnote",
            "InsertEndnote": "InsertEndnote",
            "Footnote": "Nota",
            "Endnote": "Nota di chiusura",
            "Click to View/Edit Footnote": "Fare clic per visualizzare / modificare la nota a piè di pagina",
            "Click to View/Edit Endnote": "Fare clic per visualizzare / modificare la nota di chiusura",
            "InsertAsRows": "Inserisci come nuove righe",
            "InsertAsColumns": "Inserisci come nuove colonne",
            "OverwriteCells": "Sovrascrivi celle",
            "NestTable": "Tavolo Nido",
            "No suggestions": "Nessun suggerimento",
            "More Suggestion": "Altri suggerimenti",
            "Ignore Once": "Ignora una volta",
            "Keep With Next": "Continua con il prossimo",
            "Keep Lines Together": "Tieni insieme le linee",
            "WidowControl": "Controllo vedova/orfano",
            "Indents and Spacing": "Rientri e spaziatura",
            "Line and Page Breaks": "Interruzioni di riga e di pagina",
            ...
            "ThinThickLargeGap": "ThinThickLargeGap",
            "ThinThickMediumGap": "ThinThickMediumGap",
            "Number of rows must be between 1 and 32767.": "Il numero di righe deve essere compreso tra 1 e 32767.",
            "Number of columns must be between 1 and 63.": "Il numero di colonne deve essere compreso tra 1 e 63.",
            "Unlimited": "Illimitato",
            "Regular text": "Testo regolare",
            "Date": "Data",
            "Uppercase": "Maiuscolo",
            "Lowercase": "Minuscolo",
            "FirstCapital": "Primo Capitale",
            "TitleCase": "Titlecase",
            "Filling in forms": "Compilazione moduli",
            "px": "px",
        ...
        "documenteditorcontainer": {
            ...
            "Restrict Editing": "Limita modifica",
            "Upload from computer": "Caricare dal computer",
            "By URL": "Per URL",
            ...
            "Outside borders": "Confini esterni",
            ...
            "Current Page Number": "Il numero di pagina corrente nel documento. Fai clic o tocca per navigare in una pagina specifica.",
            "Read only": "Sola lettura",
            ...
            "Hide properties pane": "Nascondi riquadro proprietà",
            "Show properties pane": "Mostra riquadro proprietà",
            "Form Fields": "Campi modulo",
            "Track Changes": "Tieni traccia delle modifiche apportate nel documento",
            "TrackChanges": "Tenere traccia delle modifiche",
            "AllCaps": "Tutto maiuscolo",
            "Change case Tooltip": "Cambia caso",
            "Insert Footnote": "Inserisci nota a piè di pagina",
            "Insert Endnote": "Inserisci nota di chiusura",
            "Footnote Tooltip": "Inserisci nota a piè di pagina (Alt + Ctrl + F).",
            "Endnote Tooltip": "Inserisci nota di chiusura (Alt + Ctrl + D).",
            "UPPERCASE": "MAIUSCOLO",
            ...
            "Heading 5": "Titolo 5",
            "Heading 6": "Titolo 6",
            "ZoomLevelTooltip": "Livello di zoom. Fare clic o toccare per aprire le opzioni di zoom.",
            "None": "Nessuno"
        },
        "carousel": {
            "nextSlide": "Prossima diapositiva",
            "of": "di",
            "pauseSlideTransition": "Metti in pausa la transizione della diapositiva",
            "playSlideTransition": "Riproduci transizione diapositiva",
