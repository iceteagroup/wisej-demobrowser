namespace Wisej.Web.Ext.DevExpressDashboard.Demo
{
    ...
    "ow: 1px 0px 16px 0px #dedede;\r\nz-index: 11;";
			...
			this.flexLayoutPanelMenu.TabIndex = 22;
			...
			this.panelComponents.TabIndex = 23;
			this.panelComponents.TabStop = true;
			this.panelComponents.Text = "Dashboards";
			// 
			// listBoxDemos
			// 
			...
			this.comboBoxDXTheme.Enabled = false;
			...
			this.comboBoxDXTheme.Text = "Light";
			...
			this.labelNavigationDemo.Size = new System.Drawing.Size(187, 22);
			this.labelNavigationDemo.TabIndex = 9;
			this.labelNavigationDemo.Text = "DevExpress Dashboard";
			// 
			// labelDemo
			// 
			...
			this.labelDemo.Text = "Sales Overview";
			...
			this.labelTitle.Size = new System.Drawing.Size(643, 82);
			this.labelTitle.TabIndex = 17;
			this.labelTitle.Text = "DevExpress Dashboard Integration Tests";
