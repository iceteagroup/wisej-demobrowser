namespace Wisej.DemoBrowser.SplitButton
{
	partial class Features
	{
		...
		private void InitializeComponent()
		{
			...
			this.splitButtonCities.ItemClicked += new Wisej.Web.MenuButtonItemClickedEventHandler(this.splitButtonRepeat_ItemClicked);
			...
			this.splitButtonRepeat.ItemClicked += new Wisej.Web.MenuButtonItemClickedEventHandler(this.splitButtonRepeat_ItemClicked);
