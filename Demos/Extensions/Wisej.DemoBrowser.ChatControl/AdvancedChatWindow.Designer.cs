...
namespace Wisej.DemoBrowser.ChatControl
{
	partial class AdvancedChatWindow
	{
		...
		private void InitializeComponent()
		{
            ...
            componentTool2,
            componentTool3});
			this.chatBox1.SentMessage += new MessageEventHandler(this.chatBox1_SendMessage);
			...
			this.chatBox1.RenderMessageControl += new Wisej.Web.Ext.ChatControl.RenderMessageControlEventHandler(this.chatBox1_MessageControlNeeded);
