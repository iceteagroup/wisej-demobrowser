...
namespace Wisej.DemoBrowser.ChatControl
{
    public class Features : DemoView
    {
        ...
        private void chatBox1_MessageControlNeeded(RenderMessageContentEventArgs e)
        {
            ...
            switch (type)
            {
                ...
                case "typing":
                    e.Control = new TypingMessageControl();
                    break;
        ...
        private MessageControl GetFileMessage(string path)
        {
        ...
        private void chatBox1_FormatMessage(FormatMessageEventArgs e)
        {
            var message = e.Message;
            var content = message.Content;
