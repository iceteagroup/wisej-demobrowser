...
namespace Wisej.DemoBrowser.RibbonBar
{
    partial class Features
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ribbonBar.Size = new System.Drawing.Size(1422, 149);
			...
			this.ribbonBarPage1.Name = "ribbonBarPage1";
			...
			// 
			this.ribbonBarItemSeparator1.Name = "ribbonBarItemSeparator1";
			// 
            ...
            this.menuItem3,
            this.menuItem4});
			this.ribbonBarItemSplitButton1.Name = "ribbonBarItemSplitButton1";
			...
			this.ribbonBarItemButton7.Name = "ribbonBarItemButton7";
			this.ribbonBarItemButton7.Text = "Folder";
			// 
			// ribbonBarItemCheckBox1
			// 
			this.ribbonBarItemCheckBox1.Name = "ribbonBarItemCheckBox1";
			...
			this.ribbonBarPage2.Name = "ribbonBarPage2";
			...
			this.ribbonBarPage3.Name = "ribbonBarPage3";
			this.ribbonBarPage3.TabBackColor = System.Drawing.Color.FromArgb(79, 191, 63);
			this.ribbonBarPage3.TabForeColor = System.Drawing.Color.FromArgb(244, 244, 244);
			...
			this.ribbonBarGroup5.Name = "ribbonBarGroup5";
			...
			this.ribbonBarItemButtonGroup1.Name = "ribbonBarItemButtonGroup1";
			// 
			// ribbonBarItemButton12
			// 
			this.ribbonBarItemButton12.ImageSource = "resource.wx/Wisej.Ext.FontAwesome/align-center.svg";
			this.ribbonBarItemButton12.Name = "ribbonBarItemButton12";
			...
			this.ribbonBarItemButton13.Name = "ribbonBarItemButton13";
			...
			this.ribbonBarItemButton14.Name = "ribbonBarItemButton14";
			...
			this.ribbonBarItemButton15.Name = "ribbonBarItemButton15";
			...
			this.ribbonBarItemButton16.Name = "ribbonBarItemButton16";
			...
			this.ribbonBarItemButton18.Name = "ribbonBarItemButton18";
			...
			this.ribbonBarItemButton19.Name = "ribbonBarItemButton19";
			...
			this.ribbonBarItemButton20.Name = "ribbonBarItemButton20";
			...
			this.ribbonBarItemButton21.Name = "ribbonBarItemButton21";
