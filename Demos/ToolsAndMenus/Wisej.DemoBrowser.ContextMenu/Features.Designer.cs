namespace Wisej.DemoBrowser.ContextMenu
{
	partial class Features
	{
		...
		private void InitializeComponent()
		{
			...
			this.menuItem1.Shortcut = Wisej.Web.Shortcut.CtrlShiftA;
			...
			this.menuItem2.Shortcut = Wisej.Web.Shortcut.CtrlShiftE;
			...
			this.menuItem4.Shortcut = Wisej.Web.Shortcut.CtrlShiftC;
			...
			this.menuItem3.Shortcut = Wisej.Web.Shortcut.CtrlShiftX;
			...
			this.checkedMenuItem1.IconSource = "icon-info";
			...
			// checkedMenuItem2
			// 
			this.checkedMenuItem2.IconSource = "icon-info";
			...
			// checkedMenuItem3
			// 
			this.checkedMenuItem3.IconSource = "icon-info";
			...
			// checkedMenuItem4
			// 
			this.checkedMenuItem4.IconSource = "icon-info";
			...
			// checkedMenuItem5
			// 
			this.checkedMenuItem5.IconSource = "icon-info";
			...
			this.menuItem10.Shortcut = Wisej.Web.Shortcut.CtrlShiftP;
			...
			this.menuItem11.Shortcut = Wisej.Web.Shortcut.CtrlShiftB;
			...
			this.linkMenuItem1.IconSource = "icon-globe";
			this.linkMenuItem1.Index = 0;
			this.linkMenuItem1.Name = "linkMenuItem1";
			this.linkMenuItem1.Shortcut = Wisej.Web.Shortcut.CtrlShiftU;
			...
			this.menuItem6.IconSource = "icon-file";
			this.menuItem6.Index = 0;
			this.menuItem6.Name = "menuItem6";
			this.menuItem6.Shortcut = Wisej.Web.Shortcut.ShiftF1;
			this.menuItem6.Text = "<b>File</b>";
			// 
			// menuItem7
			// 
			this.menuItem7.AllowHtml = true;
			this.menuItem7.IconSource = "table-row-editing";
			this.menuItem7.Index = 1;
			this.menuItem7.Name = "menuItem7";
			this.menuItem7.Shortcut = Wisej.Web.Shortcut.ShiftF2;
			this.menuItem7.Text = "<i>Edit</i>";
			// 
			// menuItem8
			// 
			this.menuItem8.AllowHtml = true;
			this.menuItem8.IconSource = "icon-file";
			this.menuItem8.Index = 2;
			this.menuItem8.Name = "menuItem8";
			this.menuItem8.Shortcut = Wisej.Web.Shortcut.CtrlShiftF3;
