...
namespace Wisej.DemoBrowser
{
    partial class MainView
    {
        ...
        private void InitializeComponent()
        {
			...
			Wisej.Resources.ComponentResourceManager resources = new Wisej.Resources.ComponentResourceManager(typeof(MainView));
			...
			this.buttonRelevantLinks = new Wisej.Web.Button();
			...
			this.panelDemoInfo = new Wisej.Web.Panel();
			this.panelDemoHost = new Wisej.Web.Panel();
			...
			this.panelDemoTitle = new Wisej.Web.Panel();
			this.labelTitle = new Wisej.Web.Label();
			this.pictureBoxControl = new Wisej.Web.PictureBox();
			this.flowLayoutPanelDemoNavigation = new Wisej.Web.FlowLayoutPanel();
			...
			this.labelNavigationSeparator3 = new Wisej.Web.Label();
			...
			this.panelDemoInfo.SuspendLayout();
			this.panelDemoHost.SuspendLayout();
			this.panel1.SuspendLayout();
			this.panelDemoTitle.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.pictureBoxControl)).BeginInit();
			this.flowLayoutPanelDemoNavigation.SuspendLayout();
			this.SuspendLayout();
			// 
			// panelMenu
			// 
    ...
    "lid;\r\nbox-shadow: 1px 0px 16px 0px #dedede;";
			...
			// this.panelMenu.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("panelMenu.ResponsiveProfiles"))));
			// this.panelMenu.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("panelMenu.ResponsiveProfiles1"))));
			this.panelMenu.ShowCloseButton = false;
			this.panelMenu.Size = new System.Drawing.Size(3040, 77);
			...
			this.menuSlideBar.Location = new System.Drawing.Point(229, 3);
			this.menuSlideBar.MinimumSize = new System.Drawing.Size(260, 0);
			this.menuSlideBar.Name = "menuSlideBar";
			// this.menuSlideBar.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("menuSlideBar.ResponsiveProfiles"))));
			this.menuSlideBar.ScrollStep = 50;
			this.menuSlideBar.Size = new System.Drawing.Size(2201, 71);
			...
			this.buttonDocs.Size = new System.Drawing.Size(218, 65);
			this.buttonDocs.TabIndex = 0;
			this.buttonDocs.Text = "Wisej.NET Documentation";
			...
			this.buttonAPI.Location = new System.Drawing.Point(247, 3);
			this.buttonAPI.Name = "buttonAPI";
			this.buttonAPI.Size = new System.Drawing.Size(114, 65);
			this.buttonAPI.TabIndex = 1;
			this.buttonAPI.Text = "Wisej.NET API";
			...
			this.buttonSupport.Location = new System.Drawing.Point(387, 3);
			...
			this.buttonMWW.Location = new System.Drawing.Point(490, 3);
			...
			this.rightPanel.Location = new System.Drawing.Point(2436, 3);
			this.rightPanel.Name = "rightPanel";
			// this.rightPanel.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("rightPanel.ResponsiveProfiles"))));
            ...
            "Graphite-3",
            "Vista-2"});
			this.comboBoxTheme.Location = new System.Drawing.Point(3, 18);
			this.comboBoxTheme.Margin = new Wisej.Web.Padding(3, 18, 3, 18);
			this.comboBoxTheme.Name = "comboBoxTheme";
			this.comboBoxTheme.Size = new System.Drawing.Size(168, 35);
			...
			this.lineMenuDivider1.Location = new System.Drawing.Point(187, 3);
			...
			this.buttonContact.Location = new System.Drawing.Point(208, 3);
			this.buttonContact.Name = "buttonContact";
			this.buttonContact.Size = new System.Drawing.Size(108, 65);
			...
			this.lineMenuDivider2.Location = new System.Drawing.Point(332, 3);
			...
			this.buttonFreeTrial.Location = new System.Drawing.Point(353, 3);
			this.buttonFreeTrial.Name = "buttonFreeTrial";
			this.buttonFreeTrial.Size = new System.Drawing.Size(121, 65);
			...
			this.lineMenuDivider3.Location = new System.Drawing.Point(490, 3);
			...
			this.buttonBuy.Location = new System.Drawing.Point(511, 3);
			this.buttonBuy.Name = "buttonBuy";
			this.buttonBuy.Size = new System.Drawing.Size(90, 65);
			...
			// this.panelComponents.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("panelComponents.ResponsiveProfiles"))));
			this.panelComponents.ShowHeader = true;
			this.panelComponents.Size = new System.Drawing.Size(345, 283);
			...
			componentTool1.ImageSource = "ribbon-delete?color=#F44235";
			componentTool1.Name = "clear";
			componentTool1.Visible = false;
			componentTool2.ImageSource = "icon-left";
			componentTool2.Name = "back";
			componentTool2.ToolTipText = "Previous (F8)";
			componentTool2.Visible = false;
			componentTool3.ImageSource = "icon-right";
			componentTool3.Name = "forward";
			componentTool3.ToolTipText = "Next (F9)";
			componentTool3.Visible = false;
			...
			this.treeViewComponents.Location = new System.Drawing.Point(48, 70);
			...
			// this.treeViewComponents.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("treeViewComponents.ResponsiveProfiles"))));
			this.treeViewComponents.SelectedImageIndex = 0;
			this.treeViewComponents.Size = new System.Drawing.Size(268, 143);
			...
			// panelMain
			// 
			this.panelMain.Controls.Add(this.panelLinks);
			this.panelMain.Controls.Add(this.panelDemoInfo);
			this.panelMain.Dock = Wisej.Web.DockStyle.Fill;
			this.panelMain.HeaderBackColor = System.Drawing.Color.FromArgb(25, 68, 156);
			this.panelMain.HeaderSize = 40;
			this.panelMain.Location = new System.Drawing.Point(345, 77);
			this.panelMain.Name = "panelMain";
			// this.panelMain.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("panelMain.ResponsiveProfiles"))));
			this.panelMain.ShowCloseButton = false;
			this.panelMain.Size = new System.Drawing.Size(2695, 283);
			this.panelMain.TabIndex = 2;
			this.panelMain.TabStop = true;
			this.panelMain.Text = "Test";
			// 
			// panelLinks
			// 
			this.panelLinks.Anchor = ((Wisej.Web.AnchorStyles)((Wisej.Web.AnchorStyles.Top | Wisej.Web.AnchorStyles.Right)));
			this.panelLinks.BackColor = System.Drawing.Color.FromArgb(97, 105, 108);
			this.panelLinks.BorderStyle = Wisej.Web.BorderStyle.Solid;
			this.panelLinks.Controls.Add(this.buttonRelevantLinks);
			this.panelLinks.Controls.Add(this.line1);
    ...
    "ius: 6px 0px 0px 6px;\r\n";
			this.panelLinks.Location = new System.Drawing.Point(2631, 71);
			this.panelLinks.Name = "panelLinks";
			// this.panelLinks.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("panelLinks.ResponsiveProfiles"))));
			this.panelLinks.Size = new System.Drawing.Size(64, 190);
			this.panelLinks.TabIndex = 22;
			this.panelLinks.TabStop = true;
			// 
			// buttonRelevantLinks
			// 
			this.buttonRelevantLinks.AppearanceKey = "button-demo";
			this.buttonRelevantLinks.BackColor = System.Drawing.Color.Transparent;
			this.buttonRelevantLinks.BackgroundImageLayout = Wisej.Web.ImageLayout.Center;
			this.buttonRelevantLinks.BackgroundImageSource = "Images/link-icon.png?color=white";
			this.buttonRelevantLinks.Dock = Wisej.Web.DockStyle.Top;
			this.buttonRelevantLinks.Focusable = false;
			this.buttonRelevantLinks.InitScript = "this.getChildControl(\"arrow\").setWidth(0);\r\nthis.getChildControl(\"arrow\").setHeig" +
    "ht(0);\r\n";
			this.buttonRelevantLinks.Location = new System.Drawing.Point(0, 132);
			this.buttonRelevantLinks.Name = "buttonRelevantLinks";
			this.buttonRelevantLinks.Size = new System.Drawing.Size(62, 55);
			this.buttonRelevantLinks.TabIndex = 4;
			this.buttonRelevantLinks.Click += new System.EventHandler(this.buttonRelevantLinks_Click);
			// 
			// line1
			// 
			...
			this.line1.Padding = new Wisej.Web.Padding(9, 0, 9, 0);
			this.line1.Size = new System.Drawing.Size(62, 11);
			// 
			// buttonDocumentation
			// 
			...
			// panelDemoInfo
			// 
			this.panelDemoInfo.Controls.Add(this.panelDemoHost);
			this.panelDemoInfo.Controls.Add(this.labelDescription);
			this.panelDemoInfo.Controls.Add(this.panelDemoTitle);
			this.panelDemoInfo.Controls.Add(this.flowLayoutPanelDemoNavigation);
			this.panelDemoInfo.Dock = Wisej.Web.DockStyle.Fill;
			this.panelDemoInfo.Location = new System.Drawing.Point(0, 0);
			this.panelDemoInfo.Name = "panelDemoInfo";
			this.panelDemoInfo.Padding = new Wisej.Web.Padding(36, 12, 85, 12);
			// this.panelDemoInfo.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("panelDemoInfo.ResponsiveProfiles"))));
			// this.panelDemoInfo.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("panelDemoInfo.ResponsiveProfiles1"))));
			this.panelDemoInfo.Size = new System.Drawing.Size(2695, 283);
			this.panelDemoInfo.TabIndex = 28;
			// 
			// panelDemoHost
			// 
			this.panelDemoHost.Controls.Add(this.panelDemo);
			this.panelDemoHost.Controls.Add(this.line6);
			this.panelDemoHost.Controls.Add(this.line4);
			this.panelDemoHost.Controls.Add(this.panel1);
			this.panelDemoHost.Dock = Wisej.Web.DockStyle.Fill;
			this.panelDemoHost.Location = new System.Drawing.Point(36, 171);
			this.panelDemoHost.Name = "panelDemoHost";
			// this.panelDemoHost.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("panelDemoHost.ResponsiveProfiles"))));
			// this.panelDemoHost.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("panelDemoHost.ResponsiveProfiles1"))));
			this.panelDemoHost.Size = new System.Drawing.Size(2574, 100);
			this.panelDemoHost.TabIndex = 27;
			// 
			// panelDemo
			// 
			...
			this.panelDemo.Location = new System.Drawing.Point(0, 65);
			...
			this.panelDemo.Size = new System.Drawing.Size(2574, 25);
            ...
            | Wisej.Web.AnchorStyles.Right)));
			this.line6.Location = new System.Drawing.Point(0, 62);
			...
			this.line4.Size = new System.Drawing.Size(2574, 5);
			// 
			// panel1
			// 
			...
			this.panel1.Size = new System.Drawing.Size(2574, 50);
			...
			this.buttonNext.Location = new System.Drawing.Point(2443, 5);
			...
			this.labelDescription.CssStyle = "display:-webkit-box;-webkit-line-clamp:4;-webkit-box-orient:vertical;";
			...
			this.labelDescription.Location = new System.Drawing.Point(36, 105);
			...
			this.labelDescription.Size = new System.Drawing.Size(2574, 66);
    ...
    "ow you can present data with just a simple array.";
			...
			// panelDemoTitle
			// 
			this.panelDemoTitle.AutoSize = true;
			this.panelDemoTitle.AutoSizeMode = Wisej.Web.AutoSizeMode.GrowAndShrink;
			this.panelDemoTitle.Controls.Add(this.labelTitle);
			this.panelDemoTitle.Controls.Add(this.pictureBoxControl);
			this.panelDemoTitle.Dock = Wisej.Web.DockStyle.Top;
			this.panelDemoTitle.Location = new System.Drawing.Point(36, 42);
			this.panelDemoTitle.Name = "panelDemoTitle";
			this.panelDemoTitle.Padding = new Wisej.Web.Padding(0, 8, 0, 0);
			// this.panelDemoTitle.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("panelDemoTitle.ResponsiveProfiles"))));
			// this.panelDemoTitle.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("panelDemoTitle.ResponsiveProfiles1"))));
			this.panelDemoTitle.Size = new System.Drawing.Size(2574, 63);
			this.panelDemoTitle.TabIndex = 26;
			// 
			// labelTitle
			// 
			...
			this.labelTitle.Location = new System.Drawing.Point(75, 8);
			this.labelTitle.Margin = new Wisej.Web.Padding(3, 3, 3, 5);
			this.labelTitle.MinimumSize = new System.Drawing.Size(223, 0);
			this.labelTitle.Name = "labelTitle";
			this.labelTitle.Padding = new Wisej.Web.Padding(0, 0, 0, 10);
			// this.labelTitle.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("labelTitle.ResponsiveProfiles"))));
			// this.labelTitle.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("labelTitle.ResponsiveProfiles1"))));
			this.labelTitle.Size = new System.Drawing.Size(421, 50);
			...
			// pictureBoxControl
			// 
			this.pictureBoxControl.Dock = Wisej.Web.DockStyle.Left;
			...
			this.pictureBoxControl.Location = new System.Drawing.Point(0, 8);
			this.pictureBoxControl.Name = "pictureBoxControl";
			this.pictureBoxControl.Padding = new Wisej.Web.Padding(0, 4, 4, 4);
			// this.pictureBoxControl.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("pictureBoxControl.ResponsiveProfiles"))));
			// this.pictureBoxControl.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("pictureBoxControl.ResponsiveProfiles1"))));
			this.pictureBoxControl.Size = new System.Drawing.Size(69, 55);
			this.pictureBoxControl.SizeMode = Wisej.Web.PictureBoxSizeMode.Zoom;
			// 
			// flowLayoutPanelDemoNavigation
			// 
			this.flowLayoutPanelDemoNavigation.Controls.Add(this.labelNavigationWisejDemos);
			this.flowLayoutPanelDemoNavigation.Controls.Add(this.labelNavigationSeparator1);
			this.flowLayoutPanelDemoNavigation.Controls.Add(this.labelNaivgationCategory);
			this.flowLayoutPanelDemoNavigation.Controls.Add(this.labelNavigationSeparator2);
			this.flowLayoutPanelDemoNavigation.Controls.Add(this.labelNavigationControl);
			this.flowLayoutPanelDemoNavigation.Controls.Add(this.labelNavigationSeparator3);
			this.flowLayoutPanelDemoNavigation.Controls.Add(this.labelNavigationDemo);
			this.flowLayoutPanelDemoNavigation.Dock = Wisej.Web.DockStyle.Top;
			this.flowLayoutPanelDemoNavigation.Location = new System.Drawing.Point(36, 12);
			this.flowLayoutPanelDemoNavigation.MinimumSize = new System.Drawing.Size(300, 0);
			this.flowLayoutPanelDemoNavigation.Name = "flowLayoutPanelDemoNavigation";
			// this.flowLayoutPanelDemoNavigation.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("flowLayoutPanelDemoNavigation.ResponsiveProfiles"))));
			// this.flowLayoutPanelDemoNavigation.ResponsiveProfiles.Add(((Wisej.Base.ResponsiveProfile)(resources.GetObject("flowLayoutPanelDemoNavigation.ResponsiveProfiles1"))));
			this.flowLayoutPanelDemoNavigation.Size = new System.Drawing.Size(2574, 30);
			this.flowLayoutPanelDemoNavigation.TabIndex = 12;
			this.flowLayoutPanelDemoNavigation.TabStop = true;
			// 
			...
			this.labelNavigationSeparator1.Size = new System.Drawing.Size(12, 15);
			...
			this.labelNavigationSeparator2.Location = new System.Drawing.Point(188, 3);
			this.labelNavigationSeparator2.Name = "labelNavigationSeparator2";
			this.labelNavigationSeparator2.Size = new System.Drawing.Size(12, 15);
			...
			this.labelNavigationControl.Location = new System.Drawing.Point(206, 3);
			...
			// 
			// labelNavigationSeparator3
			// 
			this.labelNavigationSeparator3.AutoSize = true;
			this.labelNavigationSeparator3.Font = new System.Drawing.Font("@defaultBold", 13F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Pixel);
			this.labelNavigationSeparator3.ForeColor = System.Drawing.Color.FromName("@highlightText-demo");
			this.labelNavigationSeparator3.Location = new System.Drawing.Point(296, 3);
			this.labelNavigationSeparator3.Name = "labelNavigationSeparator3";
			this.labelNavigationSeparator3.Size = new System.Drawing.Size(12, 15);
			this.labelNavigationSeparator3.TabIndex = 11;
			this.labelNavigationSeparator3.Text = ">";
			// 
			// labelNavigationDemo
			// 
			...
			this.labelNavigationDemo.Location = new System.Drawing.Point(314, 3);
			...
			this.Name = "MainView";
			this.Size = new System.Drawing.Size(3040, 360);
			...
			this.panelDemoInfo.ResumeLayout(false);
			this.panelDemoInfo.PerformLayout();
			this.panelDemoHost.ResumeLayout(false);
			this.panel1.ResumeLayout(false);
			this.panelDemoTitle.ResumeLayout(false);
			this.panelDemoTitle.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.pictureBoxControl)).EndInit();
			this.flowLayoutPanelDemoNavigation.ResumeLayout(false);
			this.flowLayoutPanelDemoNavigation.PerformLayout();
		...
		private Web.Panel panelMain;
		private Web.SlideBar menuSlideBar;
		public Web.FlowLayoutPanel flowLayoutPanelDemoNavigation;
		...
		private Web.Label labelNavigationSeparator3;
		private Web.FlexLayoutPanel rightPanel;
		private Web.Panel panel1;
		private Web.Button buttonPrevious;
        private Web.Panel panelDemoInfo;
        private Web.Panel panelDemoHost;
        private Web.Panel panelDemoTitle;
		private Web.Button buttonRelevantLinks;
